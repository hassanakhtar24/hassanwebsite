  ...
  return (
    <>
      ...
      <Waves>
        <Hero
          ...
          slides={[
            ...
            {
              media: "https://www.11-76.com/html5-videos-22/brandex/brandex.mp4",
              topText: "Image Caption #2",
              title: "Design is a process.",
              buttonText: "Watch Video",
              buttonLink: "https://www.youtube.com/watch?v=y3RQybKHsj4",
            },
            {
              media: "/assets/images/background/hero-bg-3.webp",
              topText: "Image Caption #3",
      ...
      <Section id="contact" fluid={true}>
        <Waves>
          <Contact number="07." topTitle="Let's Talk" title="The Contact" image="/assets/images/background/parallax-contact.webp" />
        </Waves>
      </Section>
